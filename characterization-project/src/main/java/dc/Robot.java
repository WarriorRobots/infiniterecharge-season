...
public class Robot extends TimedRobot {
  ...
  static private double ENCODER_EDGES_PER_REV = 23039.999999999996;
  ...
  public void robotInit() {
    ...
    WPI_TalonFX leftSlave0 = new WPI_TalonFX(14);
    ...
    rightEncoderPosition = ()
        -> rightMaster.getSelectedSensorPosition(PIDIDX) * encoderConstant * -1;
    rightEncoderRate = ()
        -> rightMaster.getSelectedSensorVelocity(PIDIDX) * encoderConstant * -1 *
               10;
