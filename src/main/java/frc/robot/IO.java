...
public class IO {
  ...
  protected static final Joystick m_leftJoystick = new Joystick(1);
  protected static final Joystick m_rightJoystick = new Joystick(0);
  protected static final XboxController m_xbox = new XboxController(2);
